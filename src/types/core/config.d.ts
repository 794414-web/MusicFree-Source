...
export interface IAppConfigProperties {
    ...
    "basic.musicDetailBackgroundMode": "songCover" | "themeColor" | "themeGradient";
    ...
    // Floating Window（悬浮窗，仅 Android）
    "basic.floatingWindow": boolean;
    "basic.floatingWindowWidth": number;
    "basic.floatingWindowHeight": number;
    "basic.floatingWindowFontSize": number;
