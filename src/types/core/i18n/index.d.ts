...
export interface ILanguageData {
    ...
    "sidebar.remoteControl": string; // 远程控制/MCP
    ...
    "basicSettings.floatingWindow": string; // 悬浮窗
    "basicSettings.floatingWindow.enable": string; // 开启悬浮窗
    "basicSettings.floatingWindow.notSupported": string; // 当前设备不支持悬浮窗
    "basicSettings.floatingWindow.width": string; // 宽度
    "basicSettings.floatingWindow.height": string; // 高度（0=自适应）
